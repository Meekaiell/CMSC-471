...
from eval_funcs import test_eval, eval_countpieces, eval_weightpieces, eval_distance_and_promotion
...
def main():
    ...
    results = []
    for i in range(5):
        results.append(play_game(eval_distance_and_promotion, 2, eval_countpieces, 2))
    print(results)
